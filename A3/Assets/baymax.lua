...
joint1 = gr.joint('joint1',{-45, 0, 45}, {0, 0, 0})
...
joint2 = gr.joint('joint2',{-45, 0, 45}, {0, 0, 0})
...
joint3 = gr.joint('joint3',{-45, 0, 45}, {0, 0, 0})
...
joint4 = gr.joint('joint4',{-45, 0, 45}, {0, 0, 0})
...
joint5 = gr.joint('joint5',{-45, 0, 45}, {0, 0, 0})
...
joint6 = gr.joint('joint6',{-45, 0, 45}, {0, 0, 0})
...
joint7 = gr.joint('joint7',{-45, 0, 45}, {0, 0, 0})
...
node8:translate(0.0, 0.75, 0.2)

joint8 = gr.joint('headJoint',{-45, 0, 45}, {-60, 0, 60})
